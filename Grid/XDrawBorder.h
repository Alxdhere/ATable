...
//-----------------------------------------------------------------------------
//----- XDrawBorder.h : Declaration of the CXDrawBorder
//-----------------------------------------------------------------------------
#pragma once
#include "resource.h"
...
//----- CXDrawBorder
class ATL_NO_VTABLE CXDrawBorder : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CXDrawBorder, &CLSID_XDrawBorder>,
	public ISupportErrorInfo,
	public IDispatchImpl<IXDrawBorder, &IID_IXDrawBorder, &LIBID_AlxdGridLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_XDRAWBORDER)

	BEGIN_COM_MAP(CXDrawBorder)
		COM_INTERFACE_ENTRY(IXDrawBorder)
...
OBJECT_ENTRY_AUTO(__uuidof(XDrawBorder), CXDrawBorder)
