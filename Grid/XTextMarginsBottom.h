...
//-----------------------------------------------------------------------------
//----- XTextMarginsBottom.h : Declaration of the CXTextMarginsBottom
//-----------------------------------------------------------------------------
#pragma once
#include "resource.h"
...
//----- CXTextMarginsBottom
class ATL_NO_VTABLE CXTextMarginsBottom : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CXTextMarginsBottom, &CLSID_XTextMarginsBottom>,
	public ISupportErrorInfo,
	public IDispatchImpl<IXTextMarginsBottom, &IID_IXTextMarginsBottom, &LIBID_AlxdGridLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_XTEXTMARGINSBOTTOM)

	BEGIN_COM_MAP(CXTextMarginsBottom)
		COM_INTERFACE_ENTRY(IXTextMarginsBottom)
...
OBJECT_ENTRY_AUTO(__uuidof(XTextMarginsBottom), CXTextMarginsBottom)
