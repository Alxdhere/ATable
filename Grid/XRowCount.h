...
//-----------------------------------------------------------------------------
//----- XRowCount.h : Declaration of the CXRowCount
//-----------------------------------------------------------------------------
#pragma once
#include "resource.h"
...
//----- CXRowCount
class ATL_NO_VTABLE CXRowCount : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CXRowCount, &CLSID_XRowCount>,
	public ISupportErrorInfo,
	public IDispatchImpl<IXRowCount, &IID_IXRowCount, &LIBID_AlxdGridLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_XROWCOUNT)

	BEGIN_COM_MAP(CXRowCount)
		COM_INTERFACE_ENTRY(IXRowCount)
...
OBJECT_ENTRY_AUTO(__uuidof(XRowCount), CXRowCount)
