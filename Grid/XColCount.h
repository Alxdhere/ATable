...
//-----------------------------------------------------------------------------
//----- XColCount.h : Declaration of the CXColCount
//-----------------------------------------------------------------------------
#pragma once
#include "resource.h"
...
//----- CXColCount
class ATL_NO_VTABLE CXColCount : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CXColCount, &CLSID_XColCount>,
	public ISupportErrorInfo,
	public IDispatchImpl<IXColCount, &IID_IXColCount, &LIBID_AlxdGridLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_XCOLCOUNT)

	BEGIN_COM_MAP(CXColCount)
		COM_INTERFACE_ENTRY(IXColCount)
...
OBJECT_ENTRY_AUTO(__uuidof(XColCount), CXColCount)
