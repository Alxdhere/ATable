...
//-----------------------------------------------------------------------------
//----- XFillCell.h : Declaration of the CXFillCell
//-----------------------------------------------------------------------------
#pragma once
#include "resource.h"
...
//----- CXFillCell
class ATL_NO_VTABLE CXFillCell : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CXFillCell, &CLSID_XFillCell>,
	public ISupportErrorInfo,
	public IDispatchImpl<IXFillCell, &IID_IXFillCell, &LIBID_AlxdGridLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_XFILLCELL)

	BEGIN_COM_MAP(CXFillCell)
		COM_INTERFACE_ENTRY(IXFillCell)
...
OBJECT_ENTRY_AUTO(__uuidof(XFillCell), CXFillCell)
