...
//-----------------------------------------------------------------------------
//----- XCellText.h : Declaration of the CXCellText
//-----------------------------------------------------------------------------
#pragma once
#include "resource.h"
...
//----- CXCellText
class ATL_NO_VTABLE CXCellText : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CXCellText, &CLSID_XCellText>,
	public ISupportErrorInfo,
	public IDispatchImpl<IXCellText, &IID_IXCellText, &LIBID_AlxdGridLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_XCELLTEXT)

	BEGIN_COM_MAP(CXCellText)
		COM_INTERFACE_ENTRY(IXCellText)
...
OBJECT_ENTRY_AUTO(__uuidof(XCellText), CXCellText)
