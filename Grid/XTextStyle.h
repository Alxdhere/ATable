...
//-----------------------------------------------------------------------------
//----- XTextStyle.h : Declaration of the CXTextStyle
//-----------------------------------------------------------------------------
#pragma once
#include "resource.h"
...
//----- CXTextStyle
class ATL_NO_VTABLE CXTextStyle : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CXTextStyle, &CLSID_XTextStyle>,
	public ISupportErrorInfo,
	public IDispatchImpl<IXTextStyle, &IID_IXTextStyle, &LIBID_AlxdGridLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_XTEXTSTYLE)

	BEGIN_COM_MAP(CXTextStyle)
		COM_INTERFACE_ENTRY(IXTextStyle)
...
OBJECT_ENTRY_AUTO(__uuidof(XTextStyle), CXTextStyle)
