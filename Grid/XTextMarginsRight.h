...
//-----------------------------------------------------------------------------
//----- XTextMarginsRight.h : Declaration of the CXTextMarginsRight
//-----------------------------------------------------------------------------
#pragma once
#include "resource.h"
...
//----- CXTextMarginsRight
class ATL_NO_VTABLE CXTextMarginsRight : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CXTextMarginsRight, &CLSID_XTextMarginsRight>,
	public ISupportErrorInfo,
	public IDispatchImpl<IXTextMarginsRight, &IID_IXTextMarginsRight, &LIBID_AlxdGridLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_XTEXTMARGINSRIGHT)

	BEGIN_COM_MAP(CXTextMarginsRight)
		COM_INTERFACE_ENTRY(IXTextMarginsRight)
...
OBJECT_ENTRY_AUTO(__uuidof(XTextMarginsRight), CXTextMarginsRight)
