...
//-----------------------------------------------------------------------------
//----- XTextHeight.h : Declaration of the CXTextHeight
//-----------------------------------------------------------------------------
#pragma once
#include "resource.h"
...
//----- CXTextHeight
class ATL_NO_VTABLE CXTextHeight : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CXTextHeight, &CLSID_XTextHeight>,
	public ISupportErrorInfo,
	public IDispatchImpl<IXTextHeight, &IID_IXTextHeight, &LIBID_AlxdGridLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_XTEXTHEIGHT)

	BEGIN_COM_MAP(CXTextHeight)
		COM_INTERFACE_ENTRY(IXTextHeight)
...
OBJECT_ENTRY_AUTO(__uuidof(XTextHeight), CXTextHeight)
