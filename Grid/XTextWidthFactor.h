...
//-----------------------------------------------------------------------------
//----- XTextWidthFactor.h : Declaration of the CXTextWidthFactor
//-----------------------------------------------------------------------------
#pragma once
#include "resource.h"
...
//----- CXTextWidthFactor
class ATL_NO_VTABLE CXTextWidthFactor : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CXTextWidthFactor, &CLSID_XTextWidthFactor>,
	public ISupportErrorInfo,
	public IDispatchImpl<IXTextWidthFactor, &IID_IXTextWidthFactor, &LIBID_AlxdGridLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_XTEXTWIDTHFACTOR)

	BEGIN_COM_MAP(CXTextWidthFactor)
		COM_INTERFACE_ENTRY(IXTextWidthFactor)
...
OBJECT_ENTRY_AUTO(__uuidof(XTextWidthFactor), CXTextWidthFactor)
