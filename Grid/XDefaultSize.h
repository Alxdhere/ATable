...
//-----------------------------------------------------------------------------
//----- XDefaultSize.h : Declaration of the CXDefaultSize
//-----------------------------------------------------------------------------
#pragma once
#include "resource.h"
...
//----- CXDefaultSize
class ATL_NO_VTABLE CXDefaultSize : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CXDefaultSize, &CLSID_XDefaultSize>,
	public ISupportErrorInfo,
	public IDispatchImpl<IXDefaultSize, &IID_IXDefaultSize, &LIBID_AlxdGridLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_XDEFAULTSIZE)

	BEGIN_COM_MAP(CXDefaultSize)
		COM_INTERFACE_ENTRY(IXDefaultSize)
...
OBJECT_ENTRY_AUTO(__uuidof(XDefaultSize), CXDefaultSize)
