...
//-----------------------------------------------------------------------------
//----- XTextObliqueAngle.h : Declaration of the CXTextObliqueAngle
//-----------------------------------------------------------------------------
#pragma once
#include "resource.h"
...
//----- CXTextObliqueAngle
class ATL_NO_VTABLE CXTextObliqueAngle : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CXTextObliqueAngle, &CLSID_XTextObliqueAngle>,
	public ISupportErrorInfo,
	public IDispatchImpl<IXTextObliqueAngle, &IID_IXTextObliqueAngle, &LIBID_AlxdGridLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_XTEXTOBLIQUEANGLE)

	BEGIN_COM_MAP(CXTextObliqueAngle)
		COM_INTERFACE_ENTRY(IXTextObliqueAngle)
...
OBJECT_ENTRY_AUTO(__uuidof(XTextObliqueAngle), CXTextObliqueAngle)
