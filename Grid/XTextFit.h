...
//-----------------------------------------------------------------------------
//----- XTextFit.h : Declaration of the CXTextFit
//-----------------------------------------------------------------------------
#pragma once
#include "resource.h"
...
//----- CXTextFit
class ATL_NO_VTABLE CXTextFit : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CXTextFit, &CLSID_XTextFit>,
	public ISupportErrorInfo,
	public IDispatchImpl<IXTextFit, &IID_IXTextFit, &LIBID_AlxdGridLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_XTEXTFIT)

	BEGIN_COM_MAP(CXTextFit)
		COM_INTERFACE_ENTRY(IXTextFit)
...
OBJECT_ENTRY_AUTO(__uuidof(XTextFit), CXTextFit)
