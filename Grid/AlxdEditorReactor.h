...
//-----------------------------------------------------------------------------
//----- AlxdEditorReactor.h : Declaration of the AlxdEditorReactor
//-----------------------------------------------------------------------------
#pragma once
...
class /*DLLIMPEXP*/ AlxdEditorReactor : public AcEditorReactor {

public:
	ACRX_DECLARE_MEMBERS(AlxdEditorReactor) ;
...
public:
	AlxdEditorReactor (const bool autoInitAndRelease =true) ;
	virtual ~AlxdEditorReactor () ;
...
#ifdef GRID_MODULE
ACDB_REGISTER_OBJECT_ENTRY_AUTO(AlxdEditorReactor)
#endif
